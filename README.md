...
| Debian package | `ros-noetic-xgc2-b2arx-description` |
...
rospack find b2arx_description
```
...
```
sudo apt update
sudo apt install ros-noetic-xgc2-b2arx-description
```
...
```text
$(rospack find b2arx_description)/urdf/b2arx_visual.urdf
```
